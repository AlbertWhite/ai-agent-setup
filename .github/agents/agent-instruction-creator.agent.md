...
description: Create or refactor the AGENTS.md file and .github/copilot-instructions.md file for this repository to be a concise, high-signal guide for coding agents.
---

Your task is to "onboard" this repository to Copilot cloud agent by adding a .github/copilot-instructions.md and AGENTS.md file in the repository that contains information describing how a cloud agent seeing it for the first time can work most efficiently.
